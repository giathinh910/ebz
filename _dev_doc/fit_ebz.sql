...
--
-- Host: localhost:3306
-- Generation Time: Dec 09, 2014 at 10:48 AM
...
(8, 2, 'Ngoc Son Temple', 'Đinh Tiên Hoàng Hàng Trống, Hoàn Kiếm', '', 'example@email.com', 1, '', 1, '21.030683, 105.852400', 'http://localhost/resource/icon/200_flat_icons/png/64px/44.png', 'Cầu Thê Húc cong cong như con tôm dẫn vào đền Ngọc Sơn', '<h1>Ngoc Son Temple</h1>\n\n<p>Cầu Th&ecirc; H&uacute;c cong cong như con t&ocirc;m dẫn v&agrave;o đền Ngọc Sơn</p>\n'),
